...
const Book = ({ title, image, author, rating, pages }: Book) => {
  return (
    <div className="w-[15rem] h-[22.5rem] bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
