...
const ShowcaseBooks=[
  { // Removed 'book1:' and made it an object directly in the array
    image:"https://images.unsplash.com/photo-1641716162046-e6fe7ce76818?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTAyfHxib29rJTIwY292ZXJ8ZW58MHx8MHx8fDA%3D",
    tag:"Technology",
    name:"Harry Potter",
    author:"J.K. Rowling",
  ...
  { // Removed 'book2:'
    image:"https://images.unsplash.com/photo-1626971992587-2cc300029e7d?q=80&w=686&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    tag:"Fantasy",
    name:"The Hobbit",
  ...
  { // Removed 'book3:'
    image:"https://images.unsplash.com/photo-1627351535879-d80b778fadd6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGJvb2slMjBjb3ZlcnByaWRlJTIwYW5kJTIwcHJlanVzdGljZXxlbnwwfHwwfHx8MA%3D%3D",
    tag:"Classic",
...
const Featured = () => {
 return (
    <div className="flex items-center justify-center flex-wrap flex-col gap-6 overflow-hidden"> {/* Added px-4 for horizontal padding */}
      <div className="flex text-center items-center mb-7 justify-center flex-col">
        ...
        <p className="text-gray-600 text-xl">Discover our handpicked selection of the most captivating reads</p>
      </div>
