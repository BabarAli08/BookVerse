...
const ReadingSidebar: React.FC<ReadingSidebarProps> = ({ 
  ...
  const actualIsOpen = sidebarOpen;
  ...
  }, [actualIsOpen, isMobile, handleCloseSidebar]);
  ...
  useEffect(() => {
    const handleEscape = (e: KeyboardEvent) => {
      if (e.key === 'Escape' && isMobile && actualIsOpen) {
        handleCloseSidebar();
      }
    };
  ...
  }, [isMobile, actualIsOpen, handleCloseSidebar]);


  useEffect(() => {
    if (isMobile && actualIsOpen) {
    ...
    <>
      ...
      <AnimatePresence>
          ...
          <motion.div
            ...
            id="reading-sidebar"
            className={`
              ${isMobile ? 'fixed top-0 pt-15 left-0 z-50 h-screen' : 'relative h-[90vh]'} 
          ...
          >
            <div className="h-full overflow-y-auto custom-scrollbar">
              ...
              <motion.div 
                className={`p-4 border-b ${togglDark ? 'border-gray-700' : 'border-gray-200'}`}
                    ...
                    >
                      ...
                      >
                        ...
                        <motion.p
                          ...
                          transition={{ duration: 0.3 }}
                        >
                          The practice of mindfulness brings awareness to the present moment.
                        </motion.p>
                      </motion.div>
                    </motion.div>
                  )}
              ...
              <motion.div 
                className={`p-4 border-t ${togglDark ? 'border-gray-700' : 'border-gray-200'}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3 }}
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <PenTool
                        className={`w-4 h-4 ${
                          togglDark ? "text-yellow-400" : "text-yellow-600"
                        }`}
                      />
                    </motion.div>
                    <h2
                      ...
                      {highlights.length > 0 && (
                        <motion.span 
                          className={`text-xs px-2 py-1 rounded-full ${
                            togglDark ? "bg-yellow-900/30 text-yellow-400" : "bg-yellow-100 text-yellow-700"
                          }`}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <AnimatePresence>
                      {notes.length > 0 && (
                        <motion.span 
                          className={`text-xs px-2 py-1 rounded-full ${
                            togglDark ? "bg-blue-900/30 text-blue-400" : "bg-blue-100 text-blue-700"
                          }`}
                          initial={{ scale: 0, opacity: 0 }}
                          animate={{ scale: 1, opacity: 1 }}
                          exit={{ scale: 0, opacity: 0 }}
                    ...
                    >
                      {annotationsLoading ? (
                        ...
                        <motion.p
                          ...
                          transition={{ duration: 0.3 }}
                        >
                          No notes yet. Select text and add notes while reading.
                        </motion.p>
                      ) : (
                        <motion.div className="space-y-2">
                          {notes.map((note, index) => (
                            <motion.div
                              key={note.id || index}
                              className={`p-3 rounded-lg border hover:opacity-90 transition-all duration-200 cursor-pointer ${
                                togglDark
                            ...
                            >
                              ...
                              <motion.blockquote
                                className={`text-xs italic mb-2 p-2 rounded border-l-2 ${
                                  togglDark
                                    ? "bg-gray-700/30 text-gray-300 border-blue-500"
                                    : "bg-blue-50 text-gray-600 border-blue-400"
                                }`}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Bookmark
                        className={`w-4 h-4 ${
                          togglDark ? "text-green-400" : "text-green-600"
                        }`}
                      />
                    </motion.div>
                    <h2
                    ...
                    <AnimatePresence>
                      ...
                      <motion.span 
                        className={`text-xs px-2 py-1 rounded-full ${
                          togglDark ? "bg-green-900/30 text-green-400" : "bg-green-100 text-green-700"
                        }`}
                        initial={{ scale: 0, opacity: 0 }}
                        animate={{ scale: 1, opacity: 1 }}
                        exit={{ scale: 0, opacity: 0 }}
                  ...
                  <motion.div
                    variants={chevronVariants}
                    animate={expandedSections.bookmarks ? "open" : "closed"}
                    transition={{ duration: 0.2 }}
                  >
                    <ChevronDown
                      className={`w-4 h-4 ${togglDark ? "text-gray-400" : "text-gray-600"}`}
                  ...
                  {expandedSections.bookmarks && (
                    ...
                    >
                      <motion.p
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        No bookmarks yet. Add bookmarks to save your reading position.
                      </motion.p>
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <motion.div 
                className={`p-4 border-t ${togglDark ? 'border-gray-700' : 'border-gray-200'} mt-auto`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
