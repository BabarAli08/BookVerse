...
const ReadingSidebar: React.FC<ReadingSidebarProps> = ({
  ...
  useEffect(() => {
    const isCompleted = completedBooks.some((b) => b.bookId == Number(book.id));
    setBookCompleted(isCompleted);
  ...
  const toggleBookCompleted = async () => {
    ...
    try {
      ...
      dispatch(updateCompletedBooks([updateBook]));
      if (error) {
      ...
      <AnimatePresence>
        <motion.div
          ...
          className={`
              ${
                isMobile
                  ? "fixed top-0 pt-15 left-0 z-50 h-screen"
                  : "relative h-[90vh]"
              } 
                  ...
                  >
                    ...
                    >
                      ...
                      <input
                        ...
                        value={letterSpacing}
                        onChange={(e) =>
                          dispatch(setLetterSpacing(e.target.value))
                        }
                        className="w-full accent-blue-500"
                      />
                      <div className="flex justify-between text-xs text-gray-500 mt-1">
                    ...
                    >
                      ...
                      <motion.p
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        The practice of mindfulness brings awareness to the
                        present moment.
                      </motion.p>
                    </motion.div>
                  </motion.div>
                  ...
                  >
                    {!annotationsFetched ? (
                      ...
                      <motion.p
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        No highlights yet. Select text while reading to create
                        highlights.
                      </motion.p>
                    ) : (
                ...
                {expandedSections.bookmarks && (
                  ...
                  >
                    <motion.p
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      No bookmarks yet. Add bookmarks to save your reading
                      position.
                    </motion.p>
                  </motion.div>
                )}
