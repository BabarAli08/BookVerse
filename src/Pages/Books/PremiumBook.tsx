...
const PremiumBookExample = () => {
  const sampleBook: PremiumBook = {
    title: "Advanced AI Ethics",
    author: "Dr. Jennifer Lee",
    description: "Navigating the ethical challenges of artificial intelligence.",
    rating: 4.7,
    image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=300&h=400&fit=crop",
    pages: 380
  };

  return (
    <div className="p-8 bg-gray-50 min-h-screen flex items-center justify-center">
      <PremiumBook {...sampleBook} />
    </div>
  );
};

export default PremiumBookExample;